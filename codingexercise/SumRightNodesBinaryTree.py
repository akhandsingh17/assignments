...
class BinaryTree(object):
    ...
    def RightNodesBinaryTreeWithoutRecurrsion(self):
...
def main():
    ...
    print(tree.RightNodesBinaryTree())
    print(tree.RightNodesBinaryTreeWithoutRecurrsion())
