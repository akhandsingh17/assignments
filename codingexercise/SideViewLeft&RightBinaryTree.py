...
class BinaryTree(object):
    ...
    def SideViewLeftRightBinaryTree(self):
        ...
        left_lst=[]
        right_lst=[]
        for str1 in ''.join(fnl_lst).split('\n'):
            left_lst.append(str1[0])
            right_lst.append(str1[len(str1)-1])

        print('Left View:',''.join(left_lst))
        print('Right View:',''.join(right_lst))
...
def main():
    ...
    tree.SideViewLeftRightBinaryTree()
